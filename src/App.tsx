...
const initialOfficers: Officer[] = [
  {
    id: 1,
    name: "Mr Mohammad M Rani",
    rank: "ACDIO",
    serviceNumber: "DIA/SO6/147",
    deployment: "ONSA",
    phone: "+2348068076158",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2017-10-01",
  },
  {
    id: 2,
    name: "Miss KI Nwosu",
    rank: "ACDIO",
    serviceNumber: "DIA/SO4/114",
    deployment: "ONSA",
    phone: "+2348012345672",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2016-09-03",
  },
  {
    id: 3,
    name: "Mr James Abbah Agada",
    rank: "ACDIO",
    serviceNumber: "DIA/SO7/163",
    deployment: "AD WKS",
    phone: "+2348012345673",
    submitted: false,
    receivedByAdmin: false,
  ...
  },
  {
    ...
    name: "Mrs FT Ibrahim",
    rank: "CDIO",
    serviceNumber: "DIA/SO8/385",
    deployment: "SO PURCHASE",
    phone: "+2348034226146",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2023-12-03",
  },
  {
    id: 5,
    name: "Miss LE Akpan",
    rank: "ACDIO",
    serviceNumber: "DIA/S12/598",
    deployment: "ONSA",
    phone: "+2348030506764",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2019-09-01",
  },
  {
    id: 6,
    name: "Mr Y Aliyu",
    rank: "ACDIO",
    serviceNumber: "DIA/S12/607",
    deployment: "Taraba Cell",
    phone: "+2348012345676",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2022-05-18",
  },
  {
    id: 7,
    name: "EM Akpan",
    rank: "ACDIO",
    serviceNumber: "DIA/S12/580",
    deployment: "Calabar Cell",
    phone: "+2347030348242",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2018-11-01",
  },
  {
    id: 8,
    name: "Ijegbunem Ibeabuchi",
    rank: "PDIO",
    serviceNumber: "DIA/S17/798",
    deployment: "SO 2 WKS",
    phone: "+2348065378409",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2019-11-20",
  },
  {
    id: 9,
    name: "Williams Salmamza",
    rank: "PDIO",
    serviceNumber: "DIA/S17/867",
    deployment: "Damaturu Cell",
    phone: "+2348098073047",
    submitted: false,
    receivedByAdmin: false,
  ...
  {
    id: 10,
    name: "Jibril Saleh Danpullo",
    rank: "SDIO",
    serviceNumber: "DIA/S17/846",
    deployment: "ONSA",
    phone: "+2347030318536",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2020-02-27",
  },
  {
    id: 11,
    name: "AA Adelegan",
    rank: "DIO III",
    serviceNumber: "DIA/J95/209",
    deployment: "Osogbo Cell",
    phone: "+2348033155422",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2006-01-06",
  },
  {
    id: 12,
    name: "Andrew Agene",
    rank: "DIO III",
    serviceNumber: "DIA/J01/283",
    deployment: "Benue Cell",
    phone: "+2347038378998",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2014-04-01",
  },
  {
    id: 13,
    name: "Peter Ochube",
    rank: "DIO III",
    serviceNumber: "DIA/J15/560",
    deployment: "PH Cell",
    phone: "+2348067922224",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2018-09-18",
  },
  {
    id: 14,
    name: "Mr D Abor",
    rank: "DIO III",
    serviceNumber: "DIA/J05/303",
    deployment: "Operations",
    phone: "+2348133370326",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2005-05-20",
  },
  {
    id: 15,
    name: "DM Osoga",
    rank: "DIO III",
    serviceNumber: "DIA/J01/247",
    deployment: "Course",
    phone: "+2348036660082",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2011-06-01",
  },
  {
    id: 16,
    name: "Sulaiman Abdullahi",
    rank: "SODI",
    serviceNumber: "DIA/J09/455",
    deployment: "AM Halidu-Giwa",
    phone: "+2348012345698",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2022-05-18",
  ...
  {
    id: 17,
    name: "Reginald Abaraonye",
    rank: "CODI",
    serviceNumber: "DIA/J17/531",
    deployment: "Ibadan Cell",
    phone: "+2348065351717",
    submitted: false,
    receivedByAdmin: false,
  ...
  {
    id: 18,
    name: "Abdulrahman A Alabi",
    rank: "CODI",
    serviceNumber: "DIA/J13/642",
    deployment: "Benin Cell",
    phone: "+2348037371990",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2016-04-16",
  },
  {
    id: 19,
    name: "Eni Anwuri Edwin",
    rank: "ADIO",
    serviceNumber: "DIA/J17/920",
    deployment: "Abakaliki Cell",
    phone: "+2349030392783",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2017-05-17",
  },
  {
    id: 20,
    name: "Yakubu Sani",
    rank: "SODI",
    serviceNumber: "DIA/J18/1013",
    deployment: "DTS",
    phone: "+2348058496199",
    submitted: false,
    receivedByAdmin: false,
    lastPromotionDate: "2021-07-21",
  },
];
...
const ProgressBar = ({
  ...
  return (
    <div className="w-full bg-gray-300 rounded-full h-4 relative">
      ...
      ></div>
      <span className="absolute right-2 top-[-1.2rem] text-sm font-semibold">
        {percentage}%
      </span>
    </div>
  );
...
const OfficerCard = ({
  ...
  return (
    <div className="bg-white shadow rounded p-4 border border-gray-200">
      ...
      <p>
        <strong>Service Number:</strong> {officer.serviceNumber}
      </p>
      <p>
        <strong>Deployment:</strong> {officer.deployment}
      </p>
      <p>
        <strong>Phone:</strong> {officer.phone}
      </p>
      <p>
        <strong>Last Promotion:</strong> {formatDate(officer.lastPromotionDate)}
      </p>
      <p>
        <strong>Days Left:</strong> {daysLeft} days
      </p>
      <div className="my-2">
        <ProgressBar daysLeft={daysLeft} totalDays={totalDays} />
      </div>
...
const App = () => {
  ...
  const handleSubmit = (id: number) => {
    setOfficers((prev) =>
      prev.map((o) => (o.id === id ? { ...o, submitted: true } : o))
    );
  };

  const handleReceive = (id: number) => {
    setOfficers((prev) =>
      prev.map((o) => (o.id === id ? { ...o, receivedByAdmin: true } : o))
    );
  };
  ...
  const filteredOfficers = officers.filter((o) => {
    const matchesSearch =
      ...
      o.deployment.toLowerCase().includes(searchTerm.toLowerCase());
    ...
    else if (filterSubmission === "Submitted")
      matchesSubmission = o.submitted && !o.receivedByAdmin;
    else if (filterSubmission === "Received")
      matchesSubmission = o.submitted && o.receivedByAdmin;
    ...
    <div className="max-w-6xl mx-auto p-6 bg-gray-50 min-h-screen">
      <header className="flex justify-between items-center mb-6">
        <img
          ...
          src="https://media.licdn.com/dms/image/v2/D4E22AQFSSnN-YOoCHA/feedshare-shrink_800/feedshare-shrink_800/0/1710951284639?e=2147483647&v=beta&t=G9ExVYnV-bThZsdIF_8Rg_-Wi7nScbiuLYM8sfgeM7w"
          alt="driver"
        />
        <h1 className="text-3xl font-extrabold text-gray-800">
          DOL PERSONNEL APER FORM TRACKER
        </h1>
        <button
